...
| 文档 | 说明 |
|------|------|
| **README.md** | 项目说明和快速开始（本文档） |
| **项目计划.md** | 完整技术方案和系统架构 |
| **API测试指南.md** | API接口文档和测试示例 |
| **测试用例.md** | 核心功能测试用例 |
| **测试说明.md** | 手机端功能测试说明 |
| **手机端功能开发计划.md** | 手机端三阶段开发计划 |
| **手机端功能开发总结.md** | 手机端功能开发总结 |
...
| 文档 | 说明 |
|------|------|
| **开发进度.md** | 早期开发进度跟踪（已过时） |
| **功能完成清单.md** | 早期功能清单（已过时） |
| **项目交付.md** | 早期项目交付文档（已过时） |
| **项目总结.md** | 早期项目总结（已过时） |
| **手动启动指南.md** | 手动启动说明（已归纳进README） |
| **文件导航.md** | 文件导航说明（已归纳进README） |
| **后端测试报告.md** | 早期后端测试报告（已过时） |
| **项目进度总结.md** | 早期项目进度总结（已过时） |
| **项目最终总结.md** | 早期项目最终总结（已过时） |
| **快速启动指南.md** | 快速启动说明（已归纳进README） |
| **第一阶段测试报告.md** | 手机端第一阶段测试报告（已过时） |
